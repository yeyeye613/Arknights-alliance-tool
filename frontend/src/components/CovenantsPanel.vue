<template>
  <section class="covenant-bar" v-if="presentCovList.length > 0">
    <div v-for="name in presentCovList" :key="name" class="cov-item"
      :class="{ 'is-active': presentCovCounts[name] >= covenantsData[name].activateCount }">
